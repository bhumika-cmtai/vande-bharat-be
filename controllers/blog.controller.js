...
const updateBlogPost = asyncHandler(async (req, res) => {
    ...
    // अपडेट किए जाने वाले डेटा को इकट्ठा करें
    const updateData = { title, content, excerpt, category, tags, status };

    // ===== अगर कोई नई इमेज अपलोड की गई है, तो उसे हैंडल करें =====
    if (req.file) {
        const newImageLocalPath = req.file.path;
        
        // S3 पर नई इमेज अपलोड करें
